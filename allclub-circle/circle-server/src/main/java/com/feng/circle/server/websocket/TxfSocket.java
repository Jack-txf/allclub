package com.feng.circle.server.websocket;

import com.feng.circle.server.config.websocket.WebSocketServerConfig;
...
@Slf4j
@ServerEndpoint(value = "/txf/socket", configurator = WebSocketServerConfig.class)
@Component
public class TxfSocket {
     ...
     * 存放所有在线的客户端
     */
    private static final Map<String, TxfSocket> clients = new ConcurrentHashMap<>();
    ...
    public void sendMessage(String message) {
        for (Map.Entry<String, TxfSocket> sessionEntry : clients.entrySet()) {
            String erp = sessionEntry.getKey();
            TxfSocket socket = sessionEntry.getValue();
    ...
    public TxfSocket getTxfSocket(String userName) {
